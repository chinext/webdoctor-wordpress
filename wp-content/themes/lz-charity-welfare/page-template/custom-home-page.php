	...
	<?php if( get_theme_mod('lz_charity_welfare_slider_hide_show') != ''){ ?>
		<section id="slider">
		  	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
			    <?php $lz_charity_welfare_slider_pages = array();
			      	for ( $count = 1; $count <= 4; $count++ ) {
				        $mod = intval( get_theme_mod( 'lz_charity_welfare_slider' . $count ));
				        if ( 'page-none-selected' != $mod ) {
				          	$lz_charity_welfare_slider_pages[] = $mod;
				        }
			      	}
			      	if( !empty($lz_charity_welfare_slider_pages) ) :
			        $args = array(
			          	'post_type' => 'page',
			          	'post__in' => $lz_charity_welfare_slider_pages,
			          	'orderby' => 'post__in'
			        );
		...
		<section id="our-services">
			<div class="container">			
				<div class="service-box">
		            ...
		            <div class="row">
			      		<?php 
			      		$lz_charity_welfare_catData1=  get_theme_mod('lz_charity_welfare_category_setting');
	          			if($lz_charity_welfare_catData1){ 
			      			$page_query = new WP_Query(array( 'category_name' => esc_html($lz_charity_welfare_catData1 ,'lz-charity-welfare')));?>
			          				...
			          				<div class="service-section">
			          					<div class="row">
				          					...
				          					<div class="col-lg-8 col-md-8 p-0">
				          						<div class="content">
								            		<h3><a href="<?php echo esc_url( get_permalink() );?>"><?php the_title(); ?></a></h3><hr>
