...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label >
		<span class="screen-reader-text"><?php echo esc_html_x( 'Search for:', 'label', 'lz-charity-welfare' ); ?></span>
	...
	<button type="submit" class="search-submit" role="tab"><?php echo esc_html_x( 'Search', 'submit button', 'lz-charity-welfare' ); ?></button>
</form>