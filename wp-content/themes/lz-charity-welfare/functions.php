...
//footer Link
define('LZ_CHARITY_WELFARE_LIVE_DEMO',__('https://www.luzukdemo.com/demo/lz-charity-welfare/','lz-charity-welfare'));
define('LZ_CHARITY_WELFARE_PRO_DOCS',__('https://luzukdemo.com/demo/lz-charity-welfare/documentation/','lz-charity-welfare'));
define('LZ_CHARITY_WELFARE_BUY_NOW',__('https://www.luzuk.com/product/charity-wordpress-theme/','lz-charity-welfare'));
...
function lz_charity_welfare_sanitize_phone_number( $phone ) {
	return preg_replace( '/[^\d+]/', '', $phone );
}

function lz_charity_welfare_sanitize_checkbox( $input ) {
	// Boolean check 
